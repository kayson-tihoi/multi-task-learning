...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10):
        ...
        self.classifier = CosineLinear(64 * block.expansion, num_classes)
        self.final_feat_dim = 10
...
def modified_resnet20(pretrained=False, **kwargs):
    n = 3
    model = ResNet(BasicBlock, [n, n, n], **kwargs)
    return model

def modified_resnet32(pretrained=False, **kwargs):
    n = 5
    model = ResNet(BasicBlock, [n, n, n], **kwargs)
    return model
